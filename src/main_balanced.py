...
from splitter import split_dataset, balance_dataset
...
def parse_args():
    ...
    Usage: python main_balanced.py ALGO TRAIN_SIZE
...
def main():
    ...
    print("Last Name, First Name, AXXXXXXXX solution (Balanced Dataset):")
